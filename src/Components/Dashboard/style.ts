...
export const CommunityListAvatar = styled.img`
  ...
  display: inline-block;
  border-radius: 4px;
  box-shadow: ${(props: any) => (props.active ? '0' : '0 1px 2px rgba(0, 0, 0, 0.1)')};
  ${Tooltip};
`;

export const FeedHeaderContainer = styled.div`
  background: ${(props: any) => props.theme.bg.default};
  padding: 14px 8px;
  box-shadow: ${Shadow.low} ${(props: any) => hexa(props.theme.bg.reverse, 0.15)};
  position: relative;
...
export const InboxThreadItem = styled.div`
  ...
  border-bottom: 1px solid
    ${(props: any) => (props.active ? props.theme.brand.alt : props.theme.bg.border)};
  background: ${(props: any) =>
...
export const ParticipantHead = styled.span`
  ...
  box-shadow: 0 0 0 2px
    ${(props: any) => (props.active ? props.theme.brand.alt : props.theme.bg.default)};
...
export const EmptyParticipantHead = styled.span`
  ...
  font-size: 11px;
  font-weight: 600;
  color: ${(props: any) => props.theme.text.alt};
  box-shadow: 0 0 0 2px
    ${(props: any) => (props.active ? props.theme.brand.alt : props.theme.bg.default)};
  width: 24px;
  height: 24px;
...
export const StatusText = styled.span`
  ...
  color: ${(props: any) =>
    props.new
      ...
      : props.active ? props.theme.text.reverse : props.theme.text.alt};
  font-weight: ${(props: any) => (props.new ? 600 : 400)};
  order: 2;
  position: relative;
  top: 4px;
...
export const PillLinkPinned = styled.div`
  background: ${(props: any) => props.theme.special.wash};
  border: 1px solid ${(props: any) => props.theme.special.border};
...
export const ClearSearch = styled.span`
  ...
  background: ${(props: any) => props.theme.text.placeholder};
  border-radius: 50%;
  font-size: 16px;
  ...
  &:hover {
    background: ${(props: any) => props.theme.text.alt};
  }
