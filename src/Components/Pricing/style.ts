...
import { hexa, zIndex } from 'Components/Globals';
...
export const Copy = styled.p`
  font-size: 20px;
  font-weight: ${(props: any) => (props.reverse ? '500' : '400')};
  color: ${(props: any) =>
...
export const Illo = styled.img`
  position: absolute;
  right: ${(props: any) => (props.right ? `${props.right}px` : '0')};
  bottom: ${(props: any) => (props.bottom ? `${props.bottom}px` : '0')};
...
export const FeatureWrapper = styled.div`
  ...
  color: ${(props: any) => props.theme[props.color].default};
  padding: 16px 0;
  align-items: center;
  grid-column-gap: 16px;
