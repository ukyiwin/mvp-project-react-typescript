          ...
          <div className="nav-overlay uk-navbar-left">
            ...
            <div className="nav-overlay uk-navbar-right uk-visible@s">
              ...
              <ul className="uk-navbar-nav uk-visible@m">
                <li>
                  <Link to="/home" className="uk-light bolder ui vertical">
                    <div className="uk-text-center">
                    <i uk-icon="icon: home" />
                    <p style={{padding: 0, margin: 0, fontSize: 11}}>Articles</p>
                    </div>
                  </Link>
                </li>
                <li>
                  <Link to="/forum" className="uk-light bolder">
                    <div className="uk-text-center">
                    <i uk-icon="icon: comment" className="float center" />
                    <p style={{padding: 0, margin: 0, fontSize: 11}}>Lounge</p>
                    </div>
                  </Link>
                </li>
                <li>
                  <Link to="/library" className="uk-light bolder">
                    <div className="uk-text-center">
                    <i uk-icon="icon: location" className="float center" />
                    <p style={{padding: 0, margin: 0, fontSize: 11}}>Library</p>
                    </div>
                  </Link>
                </li>
                <li>
                  <Link to="/connections" className="uk-light bolder">
                    <div className="uk-text-center">
                    <i uk-icon="icon: users" className="float center" />
                    <p style={{padding: 0, margin: 0, fontSize: 11}}>Connects</p>
                    </div>
                  </Link>
                </li>
                <li>
                  <Link to="/calendar" className="uk-light bolder">
                    <div className="uk-text-center">
                    <i uk-icon="icon: calendar" className="float center" />
                    <p style={{padding: 0, margin: 0, fontSize: 11}}>Calendar</p>
                    </div>
                  </Link>
                </li>
                <li>
                  <Link to="/calendar" className="uk-light bolder">
                    <div className="uk-text-center">
                    <i uk-icon="icon: user" className="float center" />
                    <p style={{padding: 0, margin: 0, fontSize: 11}}>Request</p>
                    </div>
                  </Link>
                </li>
              </ul>
            ...
            {props.isAuthenticated ? <React.Fragment>
              ...
              <div className="uk-navbar-nav uk-padding-small">
                <Link to="/write" className="circle button primary icon">+</Link>
              </div>
              </React.Fragment>
              :
              <div className="uk-navbar-nav uk-padding-small">
