...
const Avatar = (props) => {
    return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("figure", null,
        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("img", { className: `uk-border-${props.square ? 'square' : 'circle'}
         uk-animation-kenburns uk-animation-fast`, src: props.url, width: props.size, height: props.size, style: { borderRadius: 60, borderWidth: 2, borderColor: '#000' }, alt: "img" }),
...
//# sourceMappingURL=0.45c33f0a06fb1efdda2f.hot-update.js.map