...
export const NullCol = styled(FlexCol)`
  ...
  background-repeat: ${(props: any) => (props.repeat ? 'repeat-y' : 'no-repeat')};
  ...
  min-height: 160px;
  flex: 0 0 auto;
  padding: ${(props: any) => (props.noPadding ? '0' : '2rem')};
  justify-content: center;
  align-items: center;
  position: relative;
  align-self: center;
...
export const NullRow = styled(FlexRow)`
  background-image: url('/img/fills/${(props: any) =>
...
export const UpgradeError = styled.p`
  color: ${(props: any) => props.theme.warn.default};
  font-size: 14px;
  text-align: center;
  margin: 16px 0 0;
`;
