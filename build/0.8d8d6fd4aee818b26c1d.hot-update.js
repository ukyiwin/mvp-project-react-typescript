...
class FollowButton extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    ...
    render() {
        if (this.state.liked) {
            return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { className: "btn btn-primary btn-sm", onClick: this.onUnlikeClick }, "x Connected"));
        }
        else {
            return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { className: "btn btn-success btn-sm", onClick: this.onLikeClick }, "+ Connect"));
        }
    }
...
//# sourceMappingURL=0.8d8d6fd4aee818b26c1d.hot-update.js.map