...
const Avatar = (props) => {
    return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("figure", null,
        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("img", { className: `uk-border-${props.square ? 'square' : 'circle'}
                  uk-animation-kenburns uk-animation-fast`, src: props.url, width: props.size, height: props.size, alt: "img", style: { borderRadius: 60, borderWidth: 2, height: props.size, width: props.size, borderColor: '#000', backgroundColor: '#000' } }),
...
//# sourceMappingURL=0.21ddcdeda37136e72758.hot-update.js.map