...
class FollowButton extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    ...
    render() {
        if (this.state.liked) {
            return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { className: "btn btn-success uk-text-center float-right", onClick: this.onUnlikeClick }, "x Connected"));
        }
        else {
...
//# sourceMappingURL=0.4d1e8ed2dfdf680af09d.hot-update.js.map