...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_react_select_plus_dist_react_select_plus_css__ = __webpack_require__("./node_modules/react-select-plus/dist/react-select-plus.css");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__style_css__ = __webpack_require__("./src/Containers/ComposeArticle/style.css");
...
class ComposeWrite extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    ...
    addInterestContent() {
        this.props.client
            .query({
            query: __WEBPACK_IMPORTED_MODULE_2_Graphql_Query__["d" /* ALL_INTEREST */],
        })
            .then((result) => {
            ...
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "uk-width-1-1 uk-padding-large mdc-card mdc-elevation--z5 uk-padding-remove-vertical" },
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "uk-width-1-1 uk-padding-large uk-padding-remove-vertical uk-margin-top" },
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "uk-width-1-1 uk-padding-large uk-padding-remove-vertical" },
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("input", { className: "uk-article-title", style: { borderWidth: 0, fontWeight: 'bolder' }, placeholder: "Title of article" }))),
...
//# sourceMappingURL=0.5f3f3670c3e9843474b4.hot-update.js.map