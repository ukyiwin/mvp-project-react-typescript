...
class FollowButton extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    ...
    render() {
        if (this.state.liked) {
            return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { className: "btn btn-primary btn-sm uk-text-center float-right", onClick: this.onUnlikeClick }, "x Connected"));
        }
        else {
            return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { className: "btn btn-success btn-sm uk-margin-right float-right", onClick: this.onLikeClick }, "+ Connect"));
        }
    }
...
//# sourceMappingURL=0.46e745a8993a5a582952.hot-update.js.map