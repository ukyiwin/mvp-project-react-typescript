                ...
                >
                    <div className="uk-navbar-left">
                        ...
                        <a className="uk-navbar-item uk-logo" href="#">
                            <img src="https://getuikit.com/docs/images/avatar.jpg" alt="Logo" width="40" height="40" />{' '}
                            Unizonn
                        </a>
                        <ul className="uk-navbar-nav uk-visible@m">
                            ...
                            <li>
                                <Link to="/forum" className="uk-light">
                                    Forums
                                </Link>
                            </li>
                            <li>
                                <Link to="/library" className="uk-light">
                                    Library
                                </Link>
                            </li>
                        </ul>
                        <div className="uk-navbar-right uk-visible@s">
                            <ul className="uk-iconnav">
                                <li>
                                    <a href="#" uk-icon="icon: calendar; ratio: 1.5" />
                                </li>
                                <li>
                                    <a href="#" uk-icon="icon: mail; ratio: 1.5" />
                                </li>
                                <li>
                                    <a href="#" uk-icon="icon: bell; ratio: 1.5" />
                                </li>
                            </ul>
                            ...
                            <div className="uk-navbar-nav uk-padding-small">
                                <Link to="/ask" className="uk-button uk-button-primary uk-button-small">
                                    Ask question
                                </Link>
                            </div>
                            <div className="uk-navbar-nav uk-padding-small">
                                <Link to="/login" className="uk-button uk-button-default uk-button-small">
                                    Login / Register
                                </Link>
                            </div>
                        </div>
                        <div className="uk-navbar-right uk-hidden@s">
                            ...
                            <div className="uk-navbar-nav uk-padding-small">
                                <button className="uk-button uk-button-default uk-button-small uk-border-rounded">
                                    Login
                                </button>
                            </div>
                        </div>
