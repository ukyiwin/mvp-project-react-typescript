...
const PrivateLayout = (props) => {
    ...
    return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["Route"], Object.assign({}, rest, { exact: true, render: (matctProps) => isAuthenticated ? (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "container" },
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "columns uk-padding-large@s uk-padding" },
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "column col-3 uk-margin-right uk-margin-left uk-visible@m" },
                ...
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "column col-5 uk-width-expand" },
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](Component, Object.assign({}, matctProps))),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "column col-4 uk-margin-right uk-margin-left uk-visible@m", style: { marginBottom: 10 } },
...
//# sourceMappingURL=0.09467694997ad9f0a0b6.hot-update.js.map