...
const UserProfileBox = (props) => {
    return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "uk-width-1-1 uk-text-center uk-padding-small" },
        ...
        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "uk-flex uk-flex-stretch" },
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "uk-inline" },
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { className: "uk-button uk-button-default uk-button-small" }, "0 Posts")),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "uk-inline uk-button-small" },
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { className: "uk-button uk-button-default" }, "0 Connections"))),
...
//# sourceMappingURL=0.e0329ccca45b2f1557d1.hot-update.js.map