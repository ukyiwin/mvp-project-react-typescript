...
class ArticleItem extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    ...
    render() {
        ...
        return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "uk-card uk-card-small uk-width-1-1", style: {
                borderRadius: 1,
...
const InterestItemSlim = (props) => {
    return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("a", { className: "tag" }, props.name);
};
...
const PrivateHeader = (props) => {
    return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { "data-uk-sticky": "sel-target: .uk-navbar-container; cls-active: uk-navbar-sticky" },
        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("nav", { className: "uk-navbar-container uk-margin uk-background-secondary raised", "uk-navbar": true, style: { elevation: 5, borderBottomWidth: 1, borderBottomColor: '#212121' } },
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "nav-overlay uk-navbar-left" },
                ...
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["Link"], { to: "/", className: "uk-navbar-item uk-logo" },
                ...
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("ul", { className: "nav-overlay uk-navbar-nav uk-visible@m" },
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("li", null,
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["Link"], { to: "/home", className: "uk-light uk-text-bold" }, "Articles")),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("li", null,
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["Link"], { to: "/forum", className: "uk-light uk-text-bold" }, "Forums")),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("li", null,
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["Link"], { to: "/library", className: "uk-light uk-text-bold" }, "Library")),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("li", null,
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["Link"], { to: "/home", className: "uk-light uk-text-bold" }, "Connections"))),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "nav-overlay uk-navbar-right uk-visible@s" }, props.isAuthenticated ?
                    ...
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "uk-navbar-nav uk-padding-small" },
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["Link"], { to: "/login", className: "uk-button uk-button-primary uk-dark" }, "Get started"))),
...
const EmptyLayout = (props) => {
    ...
    return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["Route"], Object.assign({}, rest, { exact: true, render: (matctProps) => isAuthenticated ? (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "uk-flex uk-height-1-1 " },
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "uk-width-expand  uk-height-1-1 " },
...
const PrivateLayout = (props) => {
    const { component: Component, isAuthenticated } = props, rest = __rest(props, ["component", "isAuthenticated"]);
    return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["Route"], Object.assign({}, rest, { exact: true, render: (matctProps) => isAuthenticated ? (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "uk-flex uk-padding-small@s" },
...
const LoadingComponent = () => {
    return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { style: { width: '100vw', height: '100vh' } }, "Loading");
};
...
class PopoverLink extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    ...
    render() {
        ...
        return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", { className: "popover-link uk-text-bold", onMouseEnter: () => this.handleMouseEnter.bind(this), onMouseLeave: () => this.handleMouseLeave.bind(this) },
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["Link"], { to: `/${this.props.link}`, style: styleIt }, this.props.children),
            this.renderPopover()));
    }
    renderPopover() {
...
class SearchBar extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    ...
    render() {
        return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("form", { action: "/search", acceptCharset: "UTF-8", method: "get", className: "uk-search bolder uk-width-1-1" },
...
class WriteModal extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    render() {
        return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "uk-card uk-card-small uk-card-default uk-width-1-1 uk-margin-bottom", style: { borderRadius: 1, padding: 0, paddingTop: 15, marginLeft: 0, marginRight: 0 } },
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "uk-flex uk-text-middle uk-padding-small" },
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_Components_Avatar__["a" /* default */], { url: "https://getuikit.com/docs/images/avatar.jpg", presence: false, size: 40 }),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_2_react_router_dom__["Link"], { to: "/write" },
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { "data-uk-toggle": "target: #modal-close-default", className: "uk-text-center", style: { paddingLeft: 10 } },
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("p", { className: "uk-text-lead uk-text-center" }, "Write an article..."))))));
    }
}
    ...
    render() {
        ...
        return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "uk-flex-stretch " },
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_react_helmet__["Helmet"], null,
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("title", null, "Unizonn | Home"),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("meta", { name: "an inclusive community", content: "Unizonn community" })),
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "base-slider owl-carousel owl-theme" },
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "item" },
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("img", { src: "Assets/img/slider-light.jpg", alt: "slider" }),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "inside" },
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("h2", null, "Best Web Hosting For Your Website"),
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("p", null, "get best speed for your website. dont loose more clients."),
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("a", { href: "service-page.html", className: "custom-btn" }, "Get Started Now"))),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "item" },
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("img", { src: "Assets/img/slider-light.svg", alt: "slider" }),
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "inside" },
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("h2", null, "Best Web Hosting For Your Website"),
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("p", null, "get best speed for your website. dont loose more clients."),
                        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("a", { href: "service-page.html", className: "custom-btn" }, "Get Started Now")))),
...
//# sourceMappingURL=0.05684f06eafc92b21996.hot-update.js.map