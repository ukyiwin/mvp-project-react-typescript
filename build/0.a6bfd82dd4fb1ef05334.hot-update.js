...
class FollowButton extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    ...
    render() {
        if (this.state.liked) {
            return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { className: "btn btn-success uk-text-center", onClick: this.onUnlikeClick }, "Connected"));
        }
        else {
            return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { className: "btn btn-success uk-margin-right", onClick: this.onLikeClick }, "Connect"));
        }
    }
...
//# sourceMappingURL=0.a6bfd82dd4fb1ef05334.hot-update.js.map