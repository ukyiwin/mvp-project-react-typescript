...
g.setAttribute("id", "edita");
document.body.appendChild(g);
g.className="ui-flex-middle"
...
type DefaultOptions = {
  ...
  xhr: object,
  data_storage: object,
  default_wrappers: object[],
  key_commands: object,
  character_convert_mapping: object,
...
export default class Editor extends React.Component {
  ...
  constructor(props) {
    super(props)
    let config = Map(fromJS(this.defaultOptionz(props.config)))
    this.options = config.mergeDeep(props.config).toJS()
  }

  defaultOptionz(options) {
    // default options
    if (options == null) {
      options = {}
    }
    let defaultOptions: DefaultOptions = {
      ...
      body_placeholder: "Write your article or story",
