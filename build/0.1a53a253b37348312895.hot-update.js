    ...
    render() {
        ...
        return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "uk-flex-stretch " },
            ...
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { id: "bg1", className: "uk-flex uk-width-1-1 uk-flex-stretch uk-height-large backgroundOne", style: { height: '100vh' } },
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "uk-container uk-container-expand uk-position-center-left uk-flex uk-width-1-2" },
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_2_Components_InputBoxLogin__["a" /* default */], null)),
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "uk-container uk-container-expand uk-flex  uk-width-1-2", style: { marginTop: 80, elevation: 3, padding: 5, borderRadius: 8 } },
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("iframe", { src: "//www.youtube.com/embed/a_ONcLi8tfY?autoplay=0&showinfo=0&rel=0&modestbranding=1&playsinline=1", width: "560", height: "315", frameBorder: "1", "data-uk-responsive": true, "uk-video": "automute: true; autoplay: false" })))));
    }
}
...
//# sourceMappingURL=0.1a53a253b37348312895.hot-update.js.map