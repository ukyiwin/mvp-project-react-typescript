...
const PrivateLayout = (props) => {
    ...
    return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["Route"], Object.assign({}, rest, { exact: true, render: (matctProps) => isAuthenticated ? (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "uk-flex uk-padding-large@s uk-padding@m" },
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "uk-width-1-7 uk-margin-right uk-margin-left uk-visible@m" },
            ...
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "uk-width-2-7 uk-margin-right uk-margin-left uk-visible@m", style: { marginBottom: 10 } },
...
//# sourceMappingURL=0.9d6809c00b8ad85deadf.hot-update.js.map