...
const Section = (props: ThemeProps) => {
  switch (props.background) {
    default:
      return (
        <Default>
          <ClusterOne src="../../Assets/img/cluster-1.svg" role="presentation" />
          <ClusterTwo src="../../Assets/img/cluster-2.svg" role="presentation" />
          <ClusterThree src="../../Assets/img/cluster-5.svg" role="presentation" />
          <ClusterFour src="../../Assets/img/cluster-4.svg" role="presentation" />
          {props.children}
          <Goop {...props} />
        </Default>
      );
