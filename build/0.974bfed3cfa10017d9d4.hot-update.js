...
class ArticleItem extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    ...
    render() {
        ...
        return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "uk-card mdl-card uk-card-small uk-width-1-1", style: {
                borderRadius: 1,
                marginBottom: this.props.small ? 7 : 15,
                padding: 10,
                backgroundColor: '#fff',
            } },
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { "data-uk-lightbox": "animation: fade; video-autoplay: true;", className: "uk-inline-clip uk-transition-toggle", style: { borderRadius: 12, marginTop: 10 } },
                __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("a", { className: "uk-inline", href: "https://picturepan2.github.io/spectre/img/osx-yosemite.jpg" },
                    __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("img", { src: "https://picturepan2.github.io/spectre/img/osx-yosemite.jpg", className: "img-responsive uk-transition-scale-up uk-transition-opaque", alt: "..." }))),
...
//# sourceMappingURL=0.974bfed3cfa10017d9d4.hot-update.js.map