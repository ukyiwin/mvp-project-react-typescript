...
export const DropTab = styled(FlexRow)`
  ...
  @media (max-width: 768px) {
    ...
    ${(props: any) => props.hideOnMobile && css`display: none;`};
  }
...
export const LibraryTab = styled(Tab)`grid-area: library;`;

export const ConnectionTab = styled(Tab)`grid-area: connection;`;

export const ConversationTab = styled(Tab)`grid-area: conversation;`;
...
export const ExploreTab = styled(Tab)`
  ...
  ${(props: any) => props.loggedOut && css`grid-area: explore;`} ${Label} {
    @media (max-width: 768px) {
      display: flex;
    }
