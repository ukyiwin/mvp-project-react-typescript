...
class FollowButton extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    ...
    render() {
        if (this.state.liked) {
            return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("button", { className: "btn btn-primary", onClick: this.onUnlikeClick, style: { padding: 0 } }, "Connected"));
        }
        else {
...
//# sourceMappingURL=0.14b986a80c7ea0352725.hot-update.js.map