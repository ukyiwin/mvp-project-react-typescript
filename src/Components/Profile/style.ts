...
import { Button, OutlineButton, IconButton } from 'Components/Buttons';
...
export const Description = styled.div`
  ...
  a {
    font-weight: 500;
    color: ${(props: any) => props.theme.brand.alt};
