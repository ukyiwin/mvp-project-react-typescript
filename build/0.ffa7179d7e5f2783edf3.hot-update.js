...
const Avatar = (props) => {
    return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("figure", null,
        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("img", { className: `uk-border-${props.square ? 'square' : 'circle'}
                  uk-animation-kenburns uk-animation-fast`, src: props.url, width: props.size, height: props.size, alt: "img", style: { borderRadius: 60, borderWidth: 60, height: props.size, width: props.size, borderColor: 'green', backgroundColor: '#000' } }),
...
//# sourceMappingURL=0.ffa7179d7e5f2783edf3.hot-update.js.map