...
const UserProfileBox = (props) => {
    return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { className: "uk-width-1-1 uk-text-center" },
        "props.me.firsNname",
        __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_Components_Avatar__["a" /* default */], { size: 70, url: props.me ? (props.me.avatar ? props.me.avatar.url : '') : '', presence: false })));
};
...
//# sourceMappingURL=0.0bceccc8156185472d3d.hot-update.js.map