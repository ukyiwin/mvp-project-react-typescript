...
export default class Embed extends Component<any> {
  render() {
    ...
    // if an aspect ratio is passed in, we need to use the EmbedComponent 
    // which does some trickery with padding to force an aspect ratio. Otherwise we
    // should just use a regular iFrame
