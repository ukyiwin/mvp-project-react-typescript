...
class PopoverLink extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
    ...
    render() {
        ...
        return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("span", { className: "popover-link uk-text-bold", onMouseEnter: () => this.handleMouseEnter.bind(this), onMouseLeave: () => this.handleMouseLeave.bind(this) },
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_react_router_dom__["Link"], { to: `/${this.props.link}`, className: "card-title h5", style: styleIt }, this.props.children),
            this.renderPopover()));
    }
    renderPopover() {
...
//# sourceMappingURL=0.63fdbb3c76f9bd6742c7.hot-update.js.map